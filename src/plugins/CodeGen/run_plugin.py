"""
This script is called by the plugin-wrapper, CodeGen.js, which passes down the
...
plugin = CodeGen(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
