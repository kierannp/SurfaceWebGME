...
define(['css!./styles/VisualizerWidget.css'], function () {
    'use strict';

    var WIDGET_CLASS = 'visualizer';

    function VisualizerWidget(logger, container) {
    ...
    VisualizerWidget.prototype.onNodeClick = function (/*id*/) {
        // This currently changes the active node to the given id and
        // this is overridden in the controller.
    };

    VisualizerWidget.prototype.onBackgroundDblClick = function () {
